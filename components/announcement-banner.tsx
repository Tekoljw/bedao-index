...
const bannerInfos: BannerInfo[] = [
  {
    id: "ai-jason",
    desktopText: 'AI Jason (189K) calls YOYO "Vibe Versioning" — Iterate UI in Cursor 10× faster',
    ...
    <div className="fixed top-0 left-0 right-0 z-[60] bg-black border-b border-white/10">
      ...
      >
        ...
        >
          ...
          <div
            className={`w-1 h-4 banner-gradient-bar rounded-full transition-all duration-300 ease-out motion-reduce:transition-none ${
